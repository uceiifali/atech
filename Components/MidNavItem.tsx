...
const MidNavItem = ({
  ...
  return (
    ...
    >
      <div className="lg:w-[3rem] w-[2rem] h-[2rem] lg:h-[3rem] flex border-2 border-[#E6E6E6] rounded-full items-center justify-center relative">
        {logo}
      ...
      <div className="flex items-start justify-center flex-col w-[120px] h-[50px] ">
        ...
        <p className="text-[8px] md:text-[10px] lg:text-xs text-newGray font-medium">
          {desc}
        </p>
      </div>
    </button>
