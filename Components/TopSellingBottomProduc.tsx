...
const TopSellingBottomProduc = () => {
  return (
    <div className="w-[98vw] rounded lg:w-[33vw] h-[169.202px] bg-[#504872] transition-all lg:hover:bg-[#655A8F] flex lg:flex-row px-2 lg:px-6 overflow-hidden group flex-col">
      ...
      <div>
        <Image
          src={CondorTV}
          alt="CondorTV"
          className="object-contain w-full lg:w-[20vw]  h-[100px] lg:h-full lg:group-hover:scale-150 transition-all"
        />
      </div>
    </div>
  );
