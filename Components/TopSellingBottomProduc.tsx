...
const TopSellingBottomProduc = () => {
  return (
    <div className="w-[98vw] rounded lg:w-[520px] h-[169.202px] bg-[#504872] transition-all lg:hover:bg-[#655A8F] flex lg:flex-row px-2 lg:px-6 overflow-hidden group flex-col">
